...
Resultados verificados con Stata 19 ·
...
\textbf{Software}      & Stata 19 + R 4.x (car, lmtest, sandwich)\\[3pt]
\textbf{Fecha}         & \today\\
\bottomrule
\end{tabular}
...
resultados han sido verificados directamente en Stata 19 bajo la guía de la
...
\subsection{Resultados exactos de Stata 19}
