...
donde $Y$ es la variable dependiente, $X$ es la variable ecplicativa, $\beta_{0}$ es ek intercepto, $\beta_{1}$ es el coeficiente de regresion y $\epsilon$ es el error aleatorio.
